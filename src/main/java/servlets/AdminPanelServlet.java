...
public class AdminPanelServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String hotelName = String.valueOf(request.getParameter("Hotels"));
    ...
    public void hotelMenu(Application app, PrintWriter out, String hotelName, HttpSession session) {
        ...
        String queryHotels = "name: " + hotelName;
        ...
        String queryRooms = "hotel_name: " + hotelName;
        ...
        for (int i = 0; i < correctHotel.size(); i++) {
            ...
            for (int j = 0; j < hotelInfo.length-1; j++) {
